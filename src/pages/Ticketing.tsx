...
import { Ticket, CreditCard, Users, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-xl max-w-3xl mx-auto mb-12">
            Gestion des ventes de billets et analyse de fréquentation
          </p>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[Ticket, CreditCard, Users, MapPin].map((Icon, index) => (
              <motion.div
                key={index}
